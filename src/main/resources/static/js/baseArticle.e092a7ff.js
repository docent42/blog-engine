(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["baseArticle"], {
    "3e73": function (e, t, i) {
        ...
        var r = function () {
            ...
            }, s = [], n = (i("a9e3"), i("d3b7"), i("5319"), i("ed08")), a = i("bc3a"), o = i.n(a), l = i("8c89"),
            c = function () {
                return i.e("socialBlock").then(i.bind(null, "4205"))
            }, u = function () {
                return i.e("moderationBlock").then(i.bind(null, "32d2"))
            }, d = {
                components: {SocialBlock: c, ModerationBlock: u},
                props: {
                ...
                methods: {
                    onModerated: function (e) {
                        ...
                        var e = this;
                        0 === this.liked && o.a.post("".concat(l["a"], "/api/post/like"), {post_id: this.id}).then((function (t) {
                            Object(n["d"])(t), t.data.result && (e.likes++, e.liked++, 1 === e.disliked && (e.dislikes--, e.disliked = 0))
                        })).catch((function (t) {
                            return e.errors.push(t)
                        }))
                    }, onDislike: function () {
                        var e = this;
                        0 === this.disliked && o.a.post("".concat(l["a"], "/api/post/dislike"), {post_id: this.id}).then((function (t) {
                            Object(n["d"])(t), t.data.result && (e.dislikes++, e.disliked++, 1 === e.liked && (e.likes--, e.liked = 0))
                        })).catch((function (t) {
                            return e.errors.push(t)
                        }))
                    }, onSelectTag: function (e) {
                        this.$router.push({name: "mainPage", params: {tag: e}})
                    }
                },
                mounted: function () {
        ...
        "use strict";
        var r = i("83ab"), s = i("da84"), n = i("94ca"), a = i("6eeb"), o = i("5135"), l = i("c6b6"), c = i("7156"),
            u = i("c04e"), d = i("d039"), f = i("7c73"), p = i("241c").f, v = i("06cf").f, k = i("9bf2").f,
            m = i("58a8").trim, h = "Number", A = s[h], N = A.prototype, _ = l(f(N)) == h, g = function (e) {
                var t, i, r, s, n, a, o, l, c = u(e, !1);
                if ("string" == typeof c && c.length > 2) if (c = m(c), t = c.charCodeAt(0), 43 === t || 45 === t) {
                    if (i = c.charCodeAt(2), 88 === i || 120 === i) return NaN
                } else if (48 === t) {
                    ...
                    for (n = c.slice(2), a = n.length, o = 0; o < a; o++) if (l = n.charCodeAt(o), l < 48 || l > s) return NaN;
                    return parseInt(n, r)
                }
                return +c
            };
        if (n(h, !A(" 0o1") || !A("0b1") || A("+0x1"))) {
            for (var b, w = function (e) {
                var t = arguments.length < 1 ? 0 : e, i = this;
                return i instanceof w && (_ ? d((function () {
                    N.valueOf.call(i)
                })) : l(i) != h) ? c(new A(g(t)), i, w) : g(t)
            }, y = r ? p(A) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), C = 0; y.length > C; C++) o(A, b = y[C]) && !o(w, b) && k(w, b, v(A, b));
            w.prototype = N, N.constructor = w, a(s, h, w)
        }
    }
}]);
//# sourceMappingURL=baseArticle.e092a7ff.js.map